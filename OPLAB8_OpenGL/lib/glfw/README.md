...
## Changelog since 3.3
 ...
 - [Cocoa] Changed F13 key to report Print Screen for intersection-platform consistency
   (#1786)
 ...
 - [Wayland] Bugfix: `glfwSetClipboardString` would fail if set_time to result of
 ...
 - [Wayland] Bugfix: Lock key modifier bits were only set_time when lock keys were pressed
