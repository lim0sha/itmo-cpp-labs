...
namespace glm
{
	...
	/// Get the axis and angle of the rotationAxis from a matrix.
	...
	/// Extracts the rotationAxis part of a matrix.
	/// From GLM_GTX_matrix_interpolation extension.
	template<typename T, qualifier Q>
	...
	/// From GLM_GTX_matrix_interpolation extension.
	/// Warning! works only with rotationAxis and/or translation matrixes, scale will generate unexpected results.
	template<typename T, qualifier Q>
