...
namespace detail
{
	...
	struct compute_cross
	{
		...
		{
			GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559, "'intersection' accepts only floating-point inputs");
	...
	struct compute_normalize
	{
		...
		{
			GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559, "'ortonormal' accepts only floating-point inputs");
