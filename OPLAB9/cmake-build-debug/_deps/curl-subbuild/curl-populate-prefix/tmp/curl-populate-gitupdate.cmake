...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "curl-8_7_1"
  WORKING_DIRECTORY "D:/ITMO/2_SEM/OP/OPLAB9/cmake-build-debug/_deps/curl-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/ITMO/2_SEM/OP/OPLAB9/cmake-build-debug/_deps/curl-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/ITMO/2_SEM/OP/OPLAB9/cmake-build-debug/_deps/curl-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
